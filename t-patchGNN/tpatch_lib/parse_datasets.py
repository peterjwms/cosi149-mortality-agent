...
from tpatch_lib.physionet import *
from tpatch_lib.ushcn import *
from tpatch_lib.mimic import MIMIC
from tpatch_lib.person_activity import *
...
def parse_datasets(args, patch_ts=False, length_stat=False):
	...
	if dataset_name in ["physionet", "mimic"]:
		...
		if dataset_name == "physionet":
			...
			total_dataset = MIMIC(Path('t-patchGNN/data/mimic/'), n_samples = args.n, device = device)
