...
from tpatch_lib.utils import get_device
...
class PhysioNet(object):
	...
	urls = [
		'http://physionet.org/files/challenge-2012/1.0.0/set-a.tar.gz',
...
def get_data_min_max(records, device):
	inf = torch.Tensor([float("Inf")])[0].to('cpu')
