...
sys.path.append(str(Path(__file__).resolve().parent.parent.parent.parent / "t-patchGNN/tPatchGNN")) # tPatchGNN
sys.path.append(str(Path(__file__).resolve().parent.parent.parent.parent / "t-patchGNN/lib"))
sys.path.append(str(Path(__file__).resolve().parent.parent.parent.parent / "t-patchGNN/lib/utils.py"))
sys.path.append(str(Path(__file__).resolve().parent.parent.parent / "lib/evaluation.py"))
from tpatch_lib import utils
from tpatch_lib.evaluation import *
...
class tPatchGNN(nn.Module):
	...
	def forward(self, time_steps_to_predict, X, truth_time_steps, mask):
